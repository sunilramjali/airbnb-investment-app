...
Gemini calls are delegated to the app's shared gemini.py gateway.
"""
...
# ---------------------------------------------------------------------------
# Gemini (delegated to the app's shared gemini.py gateway)
# ---------------------------------------------------------------------------

def call_gemini(api_key, system_prompt, user_prompt):
    combined = system_prompt + '\n\n' + user_prompt
    try:
        return gemini.generate(combined, api_key=api_key)
    except Exception:
        return None
