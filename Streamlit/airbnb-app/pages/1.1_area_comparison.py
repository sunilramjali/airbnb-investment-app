...
def load_area_strategy(_session):
    return _session.sql(
        ...
        SELECT
            ...
            SUM(ST_ANNUAL_REVENUE * LISTING_COUNT) / NULLIF(SUM(LISTING_COUNT), 0) AS ST_ANNUAL_REVENUE,
            SUM(LT_ANNUAL_RENT * LISTING_COUNT) / NULLIF(SUM(LISTING_COUNT), 0) AS LT_ANNUAL_RENT,
